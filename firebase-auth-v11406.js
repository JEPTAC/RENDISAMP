(() => {
  ...
  const GOOGLE_OAUTH_CLIENT_ID = "103022555921-i7cqb3o8tc4lbtf7n9endse1d423ck4m.apps.googleusercontent.com";
  ...
  function loadGoogleIdentityServices() {
    ...
    return new Promise((resolve,reject) => {
      ...
      script.addEventListener("load",() => {
        window.setTimeout(() => {
          if (!succeed()) fail("Google Identity Services cargó sin exponer la API de OAuth.");
        },0);
      },{once:true});
  ...
  async function signInGoogle() {
    ...
    googleSignInPromise = (async () => {
      ...
      const credential = runtime.modules.auth.GoogleAuthProvider.credential(null,accessToken);
      ...
      try {
        ...
        if (error?.code === "auth/invalid-credential"
          ...
          throw authFlowError(
            ...
            `El cliente OAuth de Google no está autorizado para ${location.origin} o no corresponde a Firebase.`,
            {cause:error,clientId:GOOGLE_OAUTH_CLIENT_ID}
          );
        }
        throw error;
      }
